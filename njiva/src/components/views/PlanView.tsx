...
import { ArrowLeft, Edit2, Trash, Circle, CheckCircle, Clock } from 'lucide-react';
...
export default function PlanView({ onBack }: PlanViewProps) {
 const { entries, updateEntry, deleteEntry } = useEntries('plan');
